...
_readr_
Criado por Hadley Wickman (RStudio), é um pacote rápido, consistente e de fácil uso. 
Ele deve ser carregado como pacote primeiro (install.packages +library).
Veja ?readr. Esse pacote foi inserido há pouco tempo na coleção de pacotes _tidyverse_, que veremos com mais detalhe quando da preparação e limpeza de dados.

A função principal é _read_delim_, com funções derivadas _read_csv_ e _read_tsv_.
...
1- Importar arquivo tabela01 com _read.table_ e _readr_. Salve com nomes diferentes e imprima os 6 primeiros registros e os 3 últimos de cada um.

...
str_pad(str_trim(nomes), width = 25, pad = " ", side="both")
...
Com nosso dataframe "estados", procure os estados que pertencem a região Norte. Veja que colocamos o padrão de procura como "N$", de forma de indicar que o padrão deve **finalizar** com "N", se não especificamos assim, a função trará também os estados do nordeste ("ND").
